...
INSERT INTO stories (id, iteration_id, storyPoints, state, name) VALUES (2,4,44444,5, '');
INSERT INTO stories (id, iteration_id, storyPoints, state, name) VALUES (3,5,10,5, '');
INSERT INTO stories (id, iteration_id, storyPoints, state, name) VALUES (4,6,100,5, '');
INSERT INTO stories (id, iteration_id, storyPoints, state, name) VALUES (5,4,1000,0, '');
