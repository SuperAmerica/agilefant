...
INSERT INTO stories (id, state, rank, storyPoints, backlog_id, name, parent_id) VALUES (1, 5, 1, 10, 1, 'Project Story 1',null); --root
INSERT INTO stories (id, state, rank, storyPoints, backlog_id, name, parent_id) VALUES (2, 1, 2, 20, 1, 'Project Story 2', null); --middle
INSERT INTO stories (id, state, rank, storyPoints, backlog_id, name, parent_id) VALUES (3, 1, 3, 30, 1, 'Project Story 3', null); -- middle
INSERT INTO stories (id, state, rank, storyPoints, backlog_id, name, parent_id) VALUES (4, 4, 4, 40, 1, 'Project Story 4', NULL); --root, leaf
