...
INSERT INTO stories_AUD (REV,REVTYPE,id,name,state,backlog_id) VALUES (2,1, 1, 'Story 1', 2, 1);


UPDATE stories SET state=4 WHERE id=1;
INSERT INTO agilefant_revisions (id,`timestamp`, userId) VALUES (3, 1279095911, 1); --20.1.2010
INSERT INTO stories_AUD (REV,REVTYPE,id,name,state,backlog_id) VALUES (3,1, 1, 'Story 1', 4, 1);