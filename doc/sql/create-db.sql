...
create table BacklogItem (id integer not null auto_increment, effortLeft integer, originalEstimate integer, name varchar(255), priority integer, description text, status integer, assignee_id integer, iterationGoal_id integer, backlog_id integer not null, primary key (id)) ENGINE=InnoDB;
...
create table Task (id integer not null auto_increment, created datetime, name varchar(255), priority integer, description text, status integer, backlogItem_id integer not null, creator_id integer, primary key (id)) ENGINE=InnoDB;
