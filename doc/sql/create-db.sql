...
create table Backlog (backlogtype varchar(31) not null, id integer not null auto_increment, name varchar(255), description text, startDate datetime, endDate datetime, rank integer not null default 0 not null, assignee_id integer, product_id integer, project_id integer, history_fk integer, owner_id integer, projectType_id integer, primary key (id)) ENGINE=InnoDB;
