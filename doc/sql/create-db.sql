...
create table BacklogItem (id integer not null auto_increment, name varchar(255), description varchar(255), backlog_id integer not null, primary key (id)) type=InnoDB;
...
alter table Backlog add index FK4E86B8DD10477021 (type_id), add constraint FK4E86B8DD10477021 foreign key (type_id) references ActivityType (id);
