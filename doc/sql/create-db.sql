...
create table Backlog (backlogtype varchar(31) not null, id integer not null auto_increment, name varchar(255), description varchar(255), startDate datetime, endDate datetime, deliverable_id integer, product_id integer, activityType_id integer, owner_id integer, primary key (id)) type=InnoDB;
create table BacklogItem (id integer not null auto_increment, priority integer, name varchar(255), description varchar(255), remainingEffortEstimate time, backlog_id integer not null, primary key (id)) type=InnoDB;
