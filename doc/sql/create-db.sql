...
create table Backlog (backlogtype varchar(31) not null, id integer not null auto_increment, name varchar(255), description varchar(255), startDate datetime, endDate datetime, deliverable_id integer, product_id integer, activityType_id integer, owner_id integer, assignee_id integer, primary key (id)) type=InnoDB;
create table BacklogItem (id integer not null auto_increment, priority integer, name varchar(255), description varchar(255), remainingEffortEstimate integer, backlog_id integer not null, assignee_id integer, primary key (id)) type=InnoDB;
create table Task (id integer not null auto_increment, created datetime, effortEstimate integer, status integer, name varchar(255), priority integer, description varchar(255), creator_id integer, backlogItem_id integer not null, assignee_id integer, primary key (id)) type=InnoDB;
...
create table IterationGoal (id integer not null auto_increment, name varchar(255), description varchar(255), iteration_id integer not null, primary key (id)) ENGINE=InnoDB;
create table Practice (id integer not null auto_increment, name varchar(255), description varchar(255), template_id integer, primary key (id)) ENGINE=InnoDB;
