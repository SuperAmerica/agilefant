...
create table BacklogItem (id integer not null auto_increment, priority integer, name varchar(255), description varchar(255), remainingEffortEstimate time, backlog_id integer not null, assignee_id integer, primary key (id)) type=InnoDB;
create table Task (id integer not null auto_increment, created datetime, effortEstimate time, status integer, name varchar(255), priority integer, description varchar(255), creator_id integer, backlogItem_id integer not null, assignee_id integer, primary key (id)) type=InnoDB;
