...
create table labels (id bigint not null auto_increment, displayName varchar(255) not null, name varchar(255) not null, timestamp datetime, creator_id integer, story_id integer, backlog_id integer, primary key (id)) ENGINE=InnoDB;
