...
create table widgets (id integer not null auto_increment, listNumber integer not null, position integer, type varchar(255) not null, widgetCollection_id integer, primary key (id)) ENGINE=InnoDB;
