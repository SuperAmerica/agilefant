...
public class DailyWorkLoadData {
    ...
    private Map<Integer, Boolean> weeklyOverload = new HashMap<Integer, Boolean>();
    ...
    public Map<Integer, Boolean> getWeeklyOverload() {
        return weeklyOverload;
    }
    public void setWeeklyOverload(Map<Integer, Boolean> weeklyOverload) {
