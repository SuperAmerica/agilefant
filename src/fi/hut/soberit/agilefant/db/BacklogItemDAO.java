...
public interface BacklogItemDAO extends GenericDAO<BacklogItem> {
	 ...
	 * placeholder task.
	 * 
	 * @param backlogItemId the ID of the backlog item the task belong to
	 * @return list of all tasks excluding the placeholder task
	 */
	public List<Task> getRealTasks(BacklogItem backlogItem);
	
	/**
	 * Returns the effort left value of the backlog item. Calculated by
	 * summing effort left values of all tasks including the placeholder
	 * task. The values are taken from <strong>task</strong>, not from 
	 * effort history.
	 * 
	 * @param backlogItem the backlog item we want the effort left value for
	...
	/**
	 * Returns the effort left value of the backlog item. Calculated by
	 * summing effort left values of all tasks except the placeholder
	 * task. The values are taken from <strong>task</strong>, not from 
	 * effort history.
	 * 
	 * @param backlogItem the backlog item we want the task sum effort left 
	 * value for
