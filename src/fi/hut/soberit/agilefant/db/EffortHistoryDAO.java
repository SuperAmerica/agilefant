...
public interface EffortHistoryDAO extends GenericDAO<EffortHistory> {
     ...
     * 
     * @param date
     *                the date for the effort history
     * @param backlog
     *                the backlog of the effort history
    ...
    /**
     * Get the most recent effort history (the nearest object backwards from the
     * given date)
     * 
     * @param date
     *                the date to start the search for
     * @param backlog
     *                the backlog of the effort history
    ...
    /**
     * Get the latest effort history (the nearest object forward from the given
     * date)
     * 
     * @param startDate
     *                the date to start the search for
     * @param endDate
     *                the and date to start the search form
     * @param backlog
     *                the backlog of the effort history
