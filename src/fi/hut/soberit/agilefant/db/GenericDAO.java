...
/**
 * Generic interface for a DAO of some type.
 * Defines minimal functionality for a DAO.
 * <p>
 * Actual DAO interfaces implement this interface, 
 * possibly adding some new functionality.
 * 
...
public interface GenericDAO<T> {
	 ...
	 * 
	 * @param object object instance to remove
	 */
	public void remove(T object);

	/**
	 * Persists given object. An ID is given, if the 
