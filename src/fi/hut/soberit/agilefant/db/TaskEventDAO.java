...
public interface TaskEventDAO extends GenericDAO<TaskEvent> {
     ...
     * 
     * @param backlogItem
     *                the backlog item for which we want the original estimate
     *                for
     * @param date
     *                the start date of the period we want the original estimate
     *                for
     ...
     * 
     * @param backlogItem
     *                the backlog item for which we want the task estimate sum
     *                for
     * @param date
     *                the start date of the period we want the task estimate sum
     *                for
