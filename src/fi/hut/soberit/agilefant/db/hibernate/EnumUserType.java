...
public class EnumUserType implements UserType, ParameterizedType {
	...
	public void setParameterValues(Properties params) {
		...
		try{
			...
			throw new MappingException("Failed to create class " + enumClassName +". Check param " + ENUM_CLASS_NAME);
		}
		useOrdinal = "true".equalsIgnoreCase(params.getProperty(USE_ORDINAL_PARAM));
	}
	...
	public void nullSafeSet(PreparedStatement stmt, Object obj, int index) throws HibernateException, SQLException {
		if (obj == null){
