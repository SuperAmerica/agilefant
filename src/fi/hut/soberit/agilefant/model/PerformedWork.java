...
/**
 * Hibernate entity bean representing an event where some work effort is logged
 * to a task. Since a PerformWork bean is also a (inherits from)
 * EstimateHistoryEvent, it also carries information of a change of effort
 * estimate.
 * <p>
