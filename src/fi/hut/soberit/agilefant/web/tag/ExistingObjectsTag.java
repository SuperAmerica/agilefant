...
public class ExistingObjectsTag extends SpringTagSupport {
	...
	public int doStartTag() throws JspException {
		productDAO = (ProductDAO)
			super.getApplicationContext().getBean("productDAO");
		deliverableDAO = (DeliverableDAO)
			super.getApplicationContext().getBean("deliverableDAO");
		iterationDAO = (IterationDAO)
			super.getApplicationContext().getBean("iterationDAO");
		activityTypeDAO = (ActivityTypeDAO)
			super.getApplicationContext().getBean("activityTypeDAO");
