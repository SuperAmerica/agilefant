...
public class DeliverableBusinessTest extends SpringTestCase {
    ...
    /**
     * Tests DeliverableBusiness class's methods moveUp, moveDown, moveToTop and
     * moveToBottom.
     */
    public void testDeliverableBusiness() {
        ...
        int delId1 = testUtility.createProject("TestDeliverable 1", startDate,
                endDate, null);
        int delId2 = testUtility.createProject("TestDeliverable 2", startDate,
                endDate, null);
        int delId3 = testUtility.createProject("TestDeliverable 3", startDate,
                endDate, null);
        int delId4 = testUtility.createProject("TestDeliverable 4", startDate,
                endDate, null);
