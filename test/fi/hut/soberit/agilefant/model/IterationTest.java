...
public class IterationTest extends TestCase {
	...
	public void testGetTimeOfDayDate() {
		...
		assertEquals("" + expectedHour1, "" + testResult1);
		assertEquals("" + expectedHour2, "" + testResult2);
		assertEquals("" + expectedHour3, "" + testResult3);
		assertEquals("" + expectedHour4, "" + testResult4);
		assertEquals("" + expectedHour5, "" + testResult5);
