...
public class CalendarUtilsTest extends TestCase {
    ...
    public void testNextMonday() {
        ...
        public void testGetProjectDaysDaysInTimeFrame(){
            ...
            assertEquals(7, this.cUtils.getProjectDaysDaysInTimeFrame(projectStart, projectEnd, start, end));
         ...
         // 2. Project not yet fully in timeframe
            ...
            projectEnd = new Date(96, 6, 2); // note months start from 0          
            assertEquals(4, this.cUtils.getProjectDaysDaysInTimeFrame(projectStart, projectEnd, start, end));
            ...
            assertEquals(5, this.cUtils.getProjectDaysDaysInTimeFrame(projectStart, projectEnd, start, end));
            ...
            projectEnd = new Date(96, 5, 6); // note months start from 0          
            assertEquals(6, this.cUtils.getProjectDaysDaysInTimeFrame(projectStart, projectEnd, start, end));
            ...
            assertEquals(1, this.cUtils.getProjectDaysDaysInTimeFrame(projectStart, projectEnd, start, end));
            ...
            assertEquals(0, this.cUtils.getProjectDaysDaysInTimeFrame(projectStart, projectEnd, start, end));
        ...
        public void testGetWeekEndDays(){
            ...
            GregorianCalendar cal = new GregorianCalendar();
            cal.setTime(start);
            assertEquals(GregorianCalendar.SATURDAY, cal.get(GregorianCalendar.DAY_OF_WEEK));
       ...
       public void testGetProjectDaysDaysList(){
           ...
           Date projectStart = new Date(96, 4, 1); // note months start from 0
           Date projectEnd = new Date(96, 6, 2); // note months start from 0          
           assertEquals(7, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, true).size());
        ...
        // 2. Project not yet fully in timeframe
           ...
           projectStart = new Date(96, 5, 4); // note months start from 0
           projectEnd = new Date(96, 6, 2); // note months start from 0          
           assertEquals(4, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, true).size());
           ...
           projectStart = new Date(96, 5, 2); // note months start from 0
           projectEnd = new Date(96, 5, 6); // note months start from 0          
           assertEquals(5, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, true).size());
           ...
           projectStart = new Date(96, 4, 1); // note months start from 0
           projectEnd = new Date(96, 5, 6); // note months start from 0          
           assertEquals(6, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, true).size());
           ...
           projectStart = new Date(96, 4, 1); // note months start from 0
           projectEnd = new Date(96, 5, 1); // note months start from 0          
           assertEquals(1, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, true).size());
           ...
           projectStart = new Date(97, 5, 7); // note months start from 0
           projectEnd = new Date(97, 6, 6); // note months start from 0          
           assertEquals(null, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, true));
      ...
      public void testGetProjectDaysDaysList_NoWeekEndDays(){
          ...
          Date projectStart = new Date(96, 4, 1); // note months start from 0
          Date projectEnd = new Date(96, 6, 2); // note months start from 0          
          assertEquals(5, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, false).size());
       ...
       // 2. Project not yet fully in timeframe
          ...
          projectStart = new Date(96, 5, 4); // note months start from 0
          projectEnd = new Date(96, 6, 2); // note months start from 0          
          assertEquals(4, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, false).size());
          ...
          projectStart = new Date(96, 4, 1); // note months start from 0
          projectEnd = new Date(96, 5, 1); // note months start from 0          
          assertEquals(0, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, false).size());
          ...
          projectStart = new Date(96, 5, 7); // note months start from 0
          projectEnd = new Date(96, 6, 6); // note months start from 0          
          assertEquals(1, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, false).size());
          ...
          projectStart = new Date(97, 5, 7); // note months start from 0
          projectEnd = new Date(97, 6, 6); // note months start from 0          
          assertEquals(null, this.cUtils.getProjectDaysList(projectStart, projectEnd, start, end, false));
