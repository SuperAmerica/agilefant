...
public class SpentEffortActionTest {
    ...
    public void testGetDaySumsByWeek() {
        ...
        expect(heBusiness.getDailySpentEffortByWeek(startDate.toLocalDate(), 11, 0, 0)).andReturn(entries);
        expect(heBusiness.calculateWeekSum(startDate.toLocalDate(), 11,0,0)).andReturn(0L);
        replay(heBusiness);
    ...
    public void testGetHourEntriesByUserAndDay() {
        ...
        expect(heBusiness.getEntriesByUserAndDay(day, 42,0,0)).andReturn(null);
        replay(heBusiness);
