...
public class ProductActionTest extends SpringTestCase {
	...
	/* Get product based on id. Check whether the id is unique. */
	...
	public void testStore() {
		...
		this.create();
		this.setProductFields(PRODUCT_ID, NAME, DESCRIPTION);
		String result = this.productAction.store();
	...
	public void testStore_withoutCreate() {
		String result = this.productAction.store();
		super.assertEquals("22 store() was unsuccessful", result, Action.SUCCESS);		
	}
	...
	public void testEdit() {
		...
		this.setProductFields(PRODUCT_ID2, NAME2, DESCRIPTION2);
		String result = this.productAction.edit();
		super.assertEquals("23 edit() was unsuccessful", result, Action.SUCCESS);
		...
		this.setProductFields(PRODUCT_ID, NAME_SYMBOLS, DESCRIPTION);
		...
		this.setProductFields(PRODUCT_ID, NAME, DESCRIPTION_SYMBOLS);
		result = this.productAction.edit();
		...
		this.setProductFields(PRODUCT_ID, NAME_LONG, DESCRIPTION);
		result = this.productAction.edit();
		...
		this.setProductFields(PRODUCT_ID, NAME, DESCRIPTION_LONG);
		result = this.productAction.edit();
		...
		this.setProductFields(PRODUCT_ID, NAME_INJECTION, DESCRIPTION);
		result = this.productAction.edit();
		...
		this.setProductFields(PRODUCT_ID, NAME, DESCRIPTION_INJECTION);
		result = this.productAction.edit();
