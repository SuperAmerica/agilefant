...
/**
 * Email utilities, for validating email addresses 
 * and sending email. Also provides the string to 
 * postfix names with, and string to prefix subjects with.
 * <p>
...
public class EmailUtil {
	...
	/**
	 * Create a "bare" simple email - instance, with only SMTP host/port configured.
	 * You need to provide other details, ie. to, from, subject and contents, before sending.
	 * <p>
	 * See http://jakarta.apache.org/commons/email/userguide.html for how to use
	 * SimpleEmail and MultiPartEmail objects. 	 
	 * 
	...
	/**
	 * Create a "bare" multipart email - instance, with only SMTP host/port configured.
	 * You need to provide other details, ie. to, from, subject and contents, before sending.
	 * <p>
	 * See http://jakarta.apache.org/commons/email/userguide.html for how to use
	 * SimpleEmail and MultiPartEmail objects. 	 
	...
	/**
	 * Creates a simple email - instance, with SMTP host/port configured,
	 * as well as to, from and subject - fields. 
	 * <p>
	 * Sender and receiver names are formatted 
	 * with formatEmailFullName, subject is formatted with formatEmailSubject.
	 * <p>
	 ...
	 * SimpleEmail and MultiPartEmail objects. 	 
	 * 
	 * @param to User to send the email to
	 * @param from User the email seems to be from
	 * @param subject email subject
	 * @return SimpleEmail object, with to, from, subject defined
	 * @throws IllegalArgumentException if to or from - user is invalid  
	 */
	public SimpleEmail createSimpleEmail(User to, User from, String subject) throws IllegalArgumentException, EmailException {
		isValidUser(from);
		isValidUser(to);
	...
	/**
	 * Creates a multipart email - instance, with SMTP host/port configured,
	 * as well as to, from and subject - fields. 
	 * <p>
	 * Sender and receiver names are formatted 
	 * with formatEmailFullName, subject is formatted with formatEmailSubject.
	 ...
	 * @throws IllegalArgumentException if to or from - user is invalid  
	 */
	public MultiPartEmail createMultiPartEmail(User to, User from, String subject) throws IllegalArgumentException, EmailException {
		isValidUser(from);
		isValidUser(to);
	...
	private void isValidUser(User user) throws IllegalArgumentException {
		...
		if(user.getEmail() == null || user.getEmail().equals(""))
			throw new IllegalArgumentException("user has no email address defined");
	}
	...
	/**
	 * Formats a subject line, prefixing it with applications
	 * subject prefix. eg "hello" -> "(Agilefant) hello".
	 * 
	...
	/**
	 * Formats a full name of a user, postfixing it with applications
	 * postfix. Eg. "John Doe" -> "John Doe (Agilefant)".
	 * 
	 * @param user full name, which to format
	 ...
	 * postfix. Eg. "John Doe" -> "John Doe (Agilefant)".
	 * 
	 * @param user user instance, full name of which to format
	 * @return formatted full name
	 */
