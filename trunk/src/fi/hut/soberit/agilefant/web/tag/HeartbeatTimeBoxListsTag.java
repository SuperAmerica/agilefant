...
/**
 * A tag for requesting task and backlog item lists for current user,
 * inside given timeframe. Lists all tasks and backlog items, belonging to 
 * a deliverable or iteration, duration of which intersects with given timeframe. Also tasks belonging
 * to a product or a deliverable/iteration with no duration specified are listed.
 *   
 * <p>
...
public class HeartbeatTimeBoxListsTag extends SpringTagSupport {
	...
	/**
	 * Java Date represents time in millisecond accuracy, even 
	 * though you would expect a day accuracy. This is used to set
	 * the time within the day. 
	 * 
	 * @param date date to modify
	 * @param hour hour within the day to set
	 * @param minute minute within the hour to set
	 * @param second second within the minute to set
	 * @param msec millisecond within the second to set
	 * @return update date
	 */ 
	...
	public int doStartTag() throws JspException {
		...
		super.getPageContext().setAttribute(
				...
				userDAO.getUnfinishedTasksByTime( 
						userDAO.get(id),
						startTime,
						endTime));
