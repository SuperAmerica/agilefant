...
S(J+"img/timeline/bubble-top-left.png",0,0,D.left,D.top);
S(J+"img/timeline/bubble-top.png",D.left,0,N,D.top);
S(J+"img/timeline/bubble-top-right.png",D.left+N,0,D.right,D.top);
S(J+"img/timeline/bubble-left.png",0,D.top,D.left,R);
S(J+"img/timeline/bubble-right.png",D.left+N,D.top,D.right,R);
S(J+"img/timeline/bubble-bottom-left.png",0,D.top+R,D.left,D.bottom);
S(J+"img/timeline/bubble-bottom.png",D.left,D.top+R,N,D.bottom);
S(J+"img/timeline/bubble-bottom-right.png",D.left+N,D.top+R,D.right,D.bottom);
...
A(V,J+"img/timeline/close-button.png",16,16);
...
A(X,J+"img/timeline/bubble-bottom-arrow.png",37,D.bottom);
I.appendChild(X);
K.style.left=Z+"px";
...
X.style.left=(C-SimileAjax.Graphics._halfArrowWidth-Z)+"px";
X.style.top="0px";
A(X,J+"img/timeline/bubble-top-arrow.png",37,D.top);
I.appendChild(X);
K.style.left=Z+"px";
...
A(X,J+"img/timeline/bubble-right-arrow.png",D.right,37);
I.appendChild(X);
...
X.style.left="0px";
X.style.top=(B-SimileAjax.Graphics._halfArrowWidth-Y)+"px";
A(X,J+"img/timeline/bubble-left-arrow.png",D.left,37);
I.appendChild(X);
...
I.style.height="33px";
I.style.background="url("+"inc/img/timeline/message-top-left.png) top left no-repeat";
I.style.paddingLeft="44px";
G.appendChild(I);
var C=H.createElement("div");
C.style.height="33px";
C.style.background="url("+"inc/img/timeline/message-top-right.png) top right no-repeat";
I.appendChild(C);
var F=H.createElement("div");
F.style.background="url("+"inc/img/timeline/message-left.png) top left repeat-y";
F.style.paddingLeft="44px";
G.appendChild(F);
var A=H.createElement("div");
A.style.background="url("+"inc/img/timeline/message-right.png) top right repeat-y";
...
B.style.height="55px";
B.style.background="url("+"inc/img/timeline/message-bottom-left.png) bottom left no-repeat";
B.style.paddingLeft="44px";
G.appendChild(B);
var E=H.createElement("div");
E.style.height="55px";
E.style.background="url("+"inc/img/timeline/message-bottom-right.png) bottom right no-repeat";
B.appendChild(E);
...
var B=SimileAjax.Graphics.createTranslucentImage("inc/img/timeline/copy.png");
