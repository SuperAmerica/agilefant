...
var K=this._timeline.getDocument().createElement("div");
K.className="timeline-event-tape " + L._bandClass;
K.style.left=E+"px";
K.style.width=B+"px";
K.style.top=J+"px";
if(L._title!=null){K.title=L._title;
...
Timeline.ClassicTheme._Impl=function(){this.firstDayOfWeek=1;
...
}var A=SimileAjax.Graphics.createTranslucentImage(Timeline.urlPrefix+(this.isHorizontal()?"img/timeline/copyright-vertical.png":"img/timeline/copyright.png"));
...
D.contentDiv.innerHTML="<img src='"+Timeline.urlPrefix+"img/timeline/progress-running.gif' /> Loading...";
