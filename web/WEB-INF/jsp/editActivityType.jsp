	...
	<table class="formTable">
		...
		<tr>
			...
			<td><ww:textarea cols="70" rows="10"
				name="activityType.description" /></td>
		</tr>
		<tr>
			<td></td>
			<td></td>
			<td><c:choose>
				...
				<c:otherwise>
					...
					<span class="deleteButton"> <ww:submit
						action="deleteActivityType" value="Delete" /> </span>
				</c:otherwise>
			</c:choose></td>
		</tr>
	</table>
		...
		<tr>
			...
			<c:if test="${!empty activityType.workTypes}">
				<div id="subItemContent"><display:table class="listTable"
					name="${activityType.workTypes}" id="row"
					requestURI="editActivityType.action?activityTypeId=${activityType.id}">
