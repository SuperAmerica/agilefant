			...
			<tr>
				<td class="backlogItemList"><display:table class="dailyWorkIteration"
					...
					<display:column sortable="true" sortProperty="name" title="Name"
						...
						<div>
						<ww:a href="#" id="dailyWorkIterationList_${row.id}" onclick="openThemeBusinessModal('dailyWorkIterationList_${row.id}', 'editBacklogItemBusinessThemes.action',${row.id},0); return false;">
						...
						<c:forEach items="${row.businessThemes}" var="businessTheme">
							<span class="businessTheme" title="${businessTheme.description}">
								<ww:a href="#" onclick="openThemeBusinessModal('dailyWorkIterationList_${row.id}', 'editBacklogItemBusinessThemes.action',${row.id}, ${businessTheme.id}); return false;">
									${businessTheme.name}
								</ww:a>
							</span>
						</c:forEach>
