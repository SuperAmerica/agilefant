...
<tr>
				<td class="backlogItemList"><display:table class="dailyWorkProject"
					...
					<display:column sortable="true" sortProperty="name" title="Name"
						...
						<div>
						<ww:a href="#" id="dailyWorkProjectsList_${row.id}" onclick="openThemeBusinessModal('dailyWorkProjectsList_${row.id}', 'editBacklogItemBusinessThemes.action',${row.id},0, ${row.product.id}); return false;">
						...
						<c:forEach items="${row.businessThemes}" var="businessTheme">
							<span class="businessTheme" title="${businessTheme.description}">
								<ww:a href="#" onclick="openThemeBusinessModal('dailyWorkProjectsList_${row.id}', 'editBacklogItemBusinessThemes.action',${row.id}, ${businessTheme.id}, ${row.product.id}); return false;">
									${businessTheme.name}
								</ww:a>
							</span>
						</c:forEach>
